...
import { Plus, GripVertical, X, CheckSquare, Square, Copy, Check } from 'lucide-react';
        ...
        {(step.mode === 'template' || step.mode === 'hybrid') && (
          <FieldGroup label="Template">
            <select value={step.template} onChange={e => onChange({ ...step, template: e.target.value })} className="scale-input w-full">
              ...
              <option>Welcome — Hello {{name}}</option>
              <option>Follow-up — Checking in on your interest</option>
              <option>Final reminder — Last message</option>
            </select>
          </FieldGroup>
        )}
