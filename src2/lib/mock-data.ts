import { Lead, Conversation, Message, Template, MeetingBrief, MeetingNote, IntelligenceItem, User, Invoice, FollowUpStep, FAQEntry, AgentMetrics, Rule } from './types';
...
export const MOCK_LEADS: Lead[] = [
  { id: 'lead-1', name: 'Mohamed Benali', phone: '+213 555 123 456', channel: 'whatsapp', stage: 'new', aiStatus: 'active', assignedTo: 'Mehdi Kaci', lastContact: '2h ago', dealValue: 15000, source: 'WhatsApp Ad', notes: 'Interested in bulk order', tags: ['vip', 'bulk'] },
  { id: 'lead-2', name: 'Amira Khelif', phone: '+213 555 234 567', channel: 'instagram', stage: 'contacted', aiStatus: 'paused', assignedTo: 'Sara Boukhalfa', lastContact: '5h ago', dealValue: 8500, source: 'Instagram Story', tags: ['repeat'] },
  { id: 'lead-3', name: 'Yacine Ouahab', phone: '+213 555 345 678', channel: 'facebook', stage: 'qualified', aiStatus: 'active', assignedTo: 'Nassim Rahmani', lastContact: '1d ago', dealValue: 22000, source: 'Facebook Ad', tags: [] },
  { id: 'lead-4', name: 'Fatima Zahra Aït', phone: '+213 555 456 789', channel: 'whatsapp', stage: 'proposal', aiStatus: 'completed', assignedTo: 'Mehdi Kaci', lastContact: '3d ago', dealValue: 45000, source: 'Referral', tags: ['enterprise'] },
  { id: 'lead-5', name: 'Rachid Bensalem', phone: '+213 555 567 890', channel: 'instagram', stage: 'closed', aiStatus: 'completed', assignedTo: 'Sara Boukhalfa', lastContact: '5d ago', dealValue: 12000, source: 'Instagram Post', tags: ['closed-won'] },
  ...
  { id: 'lead-8', name: 'Lynda Bouziane', phone: '+213 555 890 123', channel: 'instagram', stage: 'qualified', aiStatus: 'active', assignedTo: 'Sara Boukhalfa', lastContact: '2d ago', dealValue: 18000, source: 'Instagram DM', tags: [] },
  { id: 'lead-9', name: 'Mourad Terki', phone: '+213 555 901 234', channel: 'whatsapp', stage: 'proposal', aiStatus: 'paused', assignedTo: 'Nassim Rahmani', lastContact: '1d ago', dealValue: 32000, source: 'WhatsApp', tags: ['enterprise'] },
  ...
  { id: 'lead-14', name: 'Asma Merzouk', phone: '+213 555 444 555', channel: 'whatsapp', stage: 'qualified', aiStatus: 'active', assignedTo: 'Sara Boukhalfa', lastContact: '4h ago', dealValue: 16500, source: 'WhatsApp', tags: [] },
  { id: 'lead-15', name: 'Bilal Hadjadj', phone: '+213 555 555 666', channel: 'instagram', stage: 'proposal', aiStatus: 'active', assignedTo: 'Nassim Rahmani', lastContact: '2h ago', dealValue: 38000, source: 'Instagram DM', tags: ['vip'] },
  ...
  { id: 'lead-17', name: 'Abderrahmane Oukil', phone: '+213 555 777 888', channel: 'whatsapp', stage: 'new', aiStatus: 'active', assignedTo: 'Sara Boukhalfa', lastContact: '15m ago', dealValue: 5000, source: 'WhatsApp Ad', tags: [] },
  { id: 'lead-18', name: 'Dalila Benmeziani', phone: '+213 555 888 999', channel: 'instagram', stage: 'qualified', aiStatus: 'escalated', assignedTo: 'Nassim Rahmani', lastContact: '8h ago', dealValue: 21000, source: 'Instagram Post', tags: ['urgent'] },
  { id: 'lead-19', name: 'Tarek Lazreg', phone: '+213 555 999 000', channel: 'facebook', stage: 'proposal', aiStatus: 'active', assignedTo: 'Mehdi Kaci', lastContact: '3h ago', dealValue: 41000, source: 'Facebook Messenger', tags: ['enterprise'] },
  { id: 'lead-20', name: 'Imene Guerfi', phone: '+213 555 100 200', channel: 'whatsapp', stage: 'closed', aiStatus: 'completed', assignedTo: 'Sara Boukhalfa', lastContact: '14d ago', dealValue: 33000, source: 'WhatsApp', tags: ['closed-won'] },
];
...
function generateMessages(contactName: string, seed: number): Message[] {
  const msgs: Message[] = [
    ...
    { id: `m-${seed}-2`, sender: 'ai', senderName: 'Scale AI', content: `Bonjour ${contactName.split(' ')[0]} ! Merci pour votre intérêt. Je suis là pour répondre à toutes vos questions. Qu'est-ce qui vous intéresse en particulier ?`, timestamp: "10:02 AM", status: 'read' },
    ...
    { id: `m-${seed}-4`, sender: 'ai', senderName: 'Scale AI', content: "Excellent choix ! Notre plateforme Scale automatise le suivi des leads et la communication avec vos clients sur WhatsApp, Instagram et Facebook. Souhaitez-vous une démonstration ?", timestamp: "10:15 AM", status: 'delivered' },
...
export const MOCK_MEETING_BRIEFS: MeetingBrief[] = [
  {
    ...
    historyContext: 'Fatima first reached out 3 weeks ago via WhatsApp after seeing a Facebook ad. She is the purchasing manager for a mid-size e-commerce company in Algiers. She has been engaged across 3 touchpoints. AI handled the first 4 messages before Mehdi took over. Strong intent signals — asked about volume pricing and API integration.',
